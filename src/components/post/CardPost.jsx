export default function CardPost({ post }) {
  return (
    <>
      ...
      <div className="card bg-white border border-gray-200 rounded-2xl shadow-md hover:shadow-xl transition-shadow duration-300 p-4 max-w-md mt-5 w-full mx-auto">
